...
import {
  // TextAreaUtils,
  defaultTextStyle,
  getBoundsRectangle, // getFontFace,
  // getStickyFontSize,
  getStickyFontStyle,
  getStickyShapeStyle, // getTextSvgElement,
...
export class TableUtil extends TDShapeUtil<T, E> {
  ...
  getSvgElement = (/* shape: T, isDarkMode: boolean */): SVGElement | void => {
    ...
    /* shape.text, fontSize, fontFamily, textAlign, bounds.width - PADDING * 2, true */
    ...
    // g.appendChild(tableHeadItem)
    //foreignObject.appendChild(tableHeadItem)
    return g
  }
}
